...
<!--<nav class="navbar  navbar-expand-lg navbar-light rounded" style="background-color:#e80018">-->
    ...
    <div class="collapse navbar-collapse justify-content-md-center" id="navbar">
        <ul class="navbar-nav">
            <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" href="#" id="dropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Платформа</a>
    ...
    <!--<a href="/registration">-->
    <button class="button reg" ID="regB">R</button>
    </a>
    <button class="button log" ID="logB">L</button>
